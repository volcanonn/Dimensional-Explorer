...
def smart_sin(x, use_f64: ti.template()):
    if ti.static(use_f64):
        return f64_math.f64_sin(ti.cast(x, ti.f64))
    else:
...
def smart_cos(x, use_f64: ti.template()):
    if ti.static(use_f64):
        return f64_math.f64_cos(ti.cast(x, ti.f64))
    else:
...
def smart_exp(x, use_f64: ti.template()):
    if ti.static(use_f64):
        return f64_math.f64_exp(ti.cast(x, ti.f64))
    else:
...
def smart_log(x, use_f64: ti.template()):
    if ti.static(use_f64):
        return f64_math.f64_log(ti.cast(x, ti.f64))
    else:
...
def smart_atan2(y, x, use_f64: ti.template()):
    if ti.static(use_f64):
        return f64_math.f64_atan2(ti.cast(y, ti.f64), ti.cast(x, ti.f64))
    else:
